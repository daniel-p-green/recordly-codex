...
This is the v0.5.0 source and fixture contract. A local test, fixture render, or MCP tool result is not proof of a tagged release, clean-installed plugin, or live Codex Desktop Browser recording.
...
| Test proof | Output-parity fixtures render preview and final as MP4 and GIF at 1920×1080, 1080×1080, and 1080×1920, then decode checkpoints | Fixture proof is neither pixel identity nor live Desktop Browser proof |
