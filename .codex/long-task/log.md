...
- Remaining gate: Publish v0.2.0, then verify a clean marketplace install and stdio smoke from the published tag. The current headed acceptance verifies the release candidate, not that future published-tag installation.
